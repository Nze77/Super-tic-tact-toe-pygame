# REMAING TASKS: 
# {DONE}     WIN COUNTER 
# {DONE}     STOP TAKING INPUTS ON FINISHED GAME 
# {DONE}     IF THE SMALL GRID ENDS AND THE NEXT TO PLAY IS THAT ENDED GRID THEN NEXT == 0
# {DONE}     draw figures for middle 
# {DONE HOPEFULLY}  SMALL GRID DRAW GAME CONDITIONS 
# {DONE}     SOME FUCK UPS LIKE CLICK NOT CHECKING, WINS NOT CHECKING
# REACHED 700 LINES
